...
const mapRecords=new Function('normalizeWorkspaceCopyStatus','readPoiCategory','readPoiGeography','readMatrixRecord',`${executable};return mapPoiRecords`)(v=>String(v??''),readPoiCategory,readPoiGeography,readMatrixRecord)
