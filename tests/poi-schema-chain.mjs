...
try {
  /* ── 1. Карточка: детерминизм, закрытая область, ВСЕ модули цепочки ─── */
  {
    ...
    for (const rel of ['scripts/poi-schema/run-taxonomy-schema.mjs', 'scripts/poi-schema/taxonomy-schema-cli.mjs', 'scripts/poi-schema/taxonomy-schema-state.mjs', 'scripts/lib/byte-digest.mjs', 'scripts/lib/canonical-contract.mjs', 'src/lib/poi-taxonomy.ts', 'src/lib/airtable-schema.ts', 'config/poi-taxonomy.v3.json']) {
