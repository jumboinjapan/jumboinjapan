...
const registry = JSON.parse(await readFile(rel('config/poi-taxonomy.v6.json'), 'utf8'))
...
await copyFile(rel('config/poi-taxonomy.v5.json'), path.join(dir, 'config/poi-taxonomy.v5.json'))
await copyFile(rel('config/poi-taxonomy.v4.json'), path.join(dir, 'config/poi-taxonomy.v4.json'))
await copyFile(rel('config/poi-taxonomy.v3.json'), path.join(dir, 'config/poi-taxonomy.v3.json'))
...
await writeFile(path.join(dir, 'config/poi-taxonomy.v6.json'), JSON.stringify(shuffled, null, 2) + '\n')
