...
const registry = JSON.parse(await readFile(rel('config/poi-taxonomy.v5.json'), 'utf8'))
...
await writeFile(path.join(dir, 'config/poi-taxonomy.v5.json'), JSON.stringify(shuffled, null, 2) + '\n')
