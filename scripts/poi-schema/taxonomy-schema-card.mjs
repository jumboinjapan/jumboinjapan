...
const FIELD_DESCRIPTIONS = Object.freeze({
  [TAXONOMY_FIELDS.type]: 'Код типа POI из реестра таксономии (config/poi-taxonomy.v6.json). Пишет ingestPoi; подписи — из реестра, не из этого поля.',
...
export function buildTaxonomySchemaCard({ preparedAt, modules = moduleDigests() }) {
  ...
  return {
    ...
    derivedFrom: { registry: 'config/poi-taxonomy.v6.json', registryVersion: taxonomyVersion, link: 'src/lib/poi-taxonomy-airtable.ts · expectedTaxonomyFieldSchema()' },
    scope: {
