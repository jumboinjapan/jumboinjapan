...
export const PORTALS = [
  {
    ...
    // Страница-индекс: 226 уникальных ссылок вида /e/eNNN.html — вход
    // во весь их справочник направлений.
    discovery: { entry: 'https://www.japan-guide.com/e/e623a.html', linkPattern: '^/e/e\\d+\\.html$' },
    ...
    verified: { at: '2026-08-06', http: 200, bytes: 637257, links: 226, encoding: 'shift-jis' },
    notes:
  ...
  // вес считается по классу поля, а не на источник целиком.
  {
    ...
    discovery: {
      listings: [
        ...
        'https://naoshima.net/ja/foods/',
        'https://naoshima.net/ja/stay/',
      ],
    },
    licence: {
      textReuse: false,
    ...
    notes:
      'НКО «Ассоциация туризма города Наосима». Единственный источник, который ' +
      'держит остров целиком: рестораны и ночлег у Benesse не описаны вовсе. ' +
      'Раздел искусства — около 14 объектов в трёх районах (музейный, Мияноура, ' +
      'Хоммура). Проверить перед прогоном: sitemap.xml отдаётся не текстом.',
  },

  {
    ...
    notes:
      ...
      'первоисточник, выше ассоциации. Ресторанов не держит, ночлег только свой. ' +
      'Годится как сверка стабильных полей против ассоциации.',
  },
]
