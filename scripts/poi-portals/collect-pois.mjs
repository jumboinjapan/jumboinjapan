...
const CLI_OPTIONS = Object.freeze([
  ...
  },
  {
    ...
    help: [
      ...
      'входит в привязанный отпечатком план, и повторный запуск',
      'источников его не воспроизведёт. Реестр пуст, поэтому любая',
      'пара заканчивается отказом до первого адаптера.',
    ],
