...
ошибок чтения 0; партиями до 100 заполнено 807 из 1168 карточек
([последняя приёмка](poi-matrix-enrichment-2026-09-19.md)). После [регистрации 33 POI Хоккайдо](hokkaido-route-results-2026-09-20.md) остаток M4 — 361 карточка;
...
| M4. Пилот и миграция базы | Пилот 50 карточек; затем оставшиеся из 270, затем остальная база партиями до 100 (пакеты writer до 25) | Отчёт old → new по каждому POI, независимая сверка записи, исход у каждого ID; нет потерь фактов, описаний, связей и статусов | Пилот и продолжение приняты: 807/1168; прежняя очередь оценки исчерпана; осталось 361 без матрицы, из них 33 новых POI Хоккайдо; два прежних родителя остаются без подходящего свойства; ограничения полноты — в отчётах M4 и последней партии |
