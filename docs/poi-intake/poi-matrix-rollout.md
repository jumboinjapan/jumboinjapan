...
ошибок чтения 0; партиями до 100 заполнено 807 из 1135 карточек
([последняя приёмка](poi-matrix-enrichment-2026-09-19.md)). Остаток M4 — 328 карточек;
...
| M4. Пилот и миграция базы | Пилот 50 карточек; затем оставшиеся из 270, затем остальная база партиями до 100 (пакеты writer до 25) | Отчёт old → new по каждому POI, независимая сверка записи, исход у каждого ID; нет потерь фактов, описаний, связей и статусов | Пилот и продолжение приняты: 807/1135; очередь оценки исчерпана; осталось 328 без матрицы, включая два родителя без подходящего свойства; ограничения полноты — в отчётах M4 и последней партии |
