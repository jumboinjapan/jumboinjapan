...
14.09.2026. **Статус: M1 реализован, подготовлен к независимой приёмке.**
Исполняемый контракт и 40 примеров — [пакет M1](poi-matrix-m1.md).
В живой базе и интерфейсе матрица ещё не подключена.
...
Проверка предложений и чтение реализованы в пакете M1, но ещё не подключены к UI.
