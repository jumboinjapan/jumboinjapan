...
ошибок чтения 0; партиями до 100 заполнено 665 из 1135 карточек
([последняя партия](poi-matrix-m4-batch6.md)). Остаток M4 — 470 карточек;
весь этап не закрыт.
...
| M4. Пилот и миграция базы | Пилот 50 карточек; затем оставшиеся из 270, затем остальная база партиями до 100 (пакеты writer до 25) | Отчёт old → new по каждому POI, независимая сверка записи, исход у каждого ID; нет потерь фактов, описаний, связей и статусов | Пилот и продолжение приняты: 665/1135; осталось 62 оценки, 406 карточек с недостающими основаниями и два родителя без подходящего свойства; ограничения полноты — в отчётах M4 и последней партии |
