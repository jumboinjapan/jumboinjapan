...
реализован; живая схема и пилот относятся к следующему запуску M4.
...
`poi-matrix/v1`. **Живого поля пока нет; оно создаётся после проверки схемы перед пилотом M4.**
