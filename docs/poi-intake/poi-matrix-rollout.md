...
| M4. Пилот и миграция базы | Пилот 50 карточек; затем оставшиеся из 270, затем остальная база партиями до 100 (пакеты writer до 25) | Отчёт old → new по каждому POI, независимая сверка записи, исход у каждого ID; нет потерь фактов, описаний, связей и статусов | Пилот и продолжение приняты: 366/1135; осталось 362 оценки, 405 карточек с недостающими основаниями и два родителя без подходящего свойства; ограничения полноты — в отчёте M4 |
