...
const canonRulesRu = [
  ...
  /* Правило записано в каноне ещё в июле, но жило только в документе — и
     нарушалось снова. Место ему здесь, рядом с остальными. */
  '- Японские топонимы не склоняются. Исключения только три: Токио, Киото, Осака. Пиши «в Сибуя», «от Гинза», «в Нисидзин», а не «в Сибуе», «от Гинзы», «в Нисидзине».',
  '- Название POI — это место, а не занятие в нём. «Купеческий дом Тондая», а не «Чайная церемония в доме Тондая».',
]
