 ...
 *
 * Список пополняется из расхождений с живой базой — он не выдуман, а
 * измерен: scripts/check-polivanov.mjs сверяет транслитератор с 394
 * парами имён, которые владелец уже написал руками.
 */
