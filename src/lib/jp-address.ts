...
export const DESTINATIONS: readonly Destination[] = [
  { prefecture: '富山県', municipality: '高岡市', siteCity: 'takaoka' },
  { prefecture: '新潟県', municipality: '佐渡市', siteCity: 'sado' },
  { prefecture: '福島県', municipality: '会津若松市', siteCity: 'aizu-wakamatsu' },
  { prefecture: '福島県', municipality: '下郷町', siteCity: 'shimogo' },
  { prefecture: '福島県', municipality: '猪苗代町', siteCity: 'inawashiro' },
  { prefecture: '福島県', municipality: '柳津町', siteCity: 'yanaizu' },
  { prefecture: '福島県', municipality: '北塩原村', siteCity: 'kitashiobara' },
  { prefecture: '福島県', municipality: '福島市', siteCity: 'fukushima' },
  { prefecture: '福島県', municipality: 'いわき市', siteCity: 'iwaki' },
  { prefecture: '茨城県', municipality: '北茨城市', siteCity: 'kitaibaraki' },
  { prefecture: '福島県', municipality: '田村市', siteCity: 'tamura' },
  { prefecture: '徳島県', municipality: '三好市', siteCity: 'miyoshi-tokushima' },
  { prefecture: '徳島県', municipality: '鳴門市', siteCity: 'naruto' },
  { prefecture: '山形県', municipality: '鶴岡市', siteCity: 'tsuruoka' },
  { prefecture: '宮城県', municipality: '蔵王町', siteCity: 'zao' },
  { prefecture: '山形県', municipality: '酒田市', siteCity: 'sakata' },
  { prefecture: '宮崎県', municipality: '宮崎市', siteCity: 'miyazaki' },
  { prefecture: '宮崎県', municipality: '高千穂町', siteCity: 'takachiho' },
  { prefecture: '鳥取県', municipality: '鳥取市', siteCity: 'tottori' },
  { prefecture: '東京都', municipality: '小笠原村', siteCity: 'ogasawara' },
  { prefecture: '佐賀県', municipality: '有田町', siteCity: 'arita' },
  { prefecture: '佐賀県', municipality: '伊万里市', siteCity: 'imari' },

  { prefecture: '山口県', municipality: '岩国市', siteCity: 'iwakuni' },
  { prefecture: '茨城県', municipality: '水戸市', siteCity: 'mito' },
  { prefecture: '茨城県', municipality: 'ひたちなか市', siteCity: 'hitachinaka' },
  { prefecture: '静岡県', municipality: '熱海市', siteCity: 'atami' },
  { prefecture: '静岡県', municipality: '伊東市', siteCity: 'ito' },
  { prefecture: '静岡県', municipality: '下田市', siteCity: 'shimoda' },
  { prefecture: '静岡県', municipality: '掛川市', siteCity: 'kakegawa' },
  { prefecture: '静岡県', municipality: '静岡市', siteCity: 'shizuoka' },
  { prefecture: '静岡県', municipality: '富士宮市', siteCity: 'fujinomiya' },
  { prefecture: '静岡県', municipality: '裾野市', siteCity: 'susono' },
  { prefecture: '千葉県', municipality: '成田市', siteCity: 'narita' },
  { prefecture: '千葉県', municipality: '栄町', siteCity: 'sakae-chiba' },
  { prefecture: '千葉県', municipality: '芝山町', siteCity: 'shibayama' },
  { prefecture: '千葉県', municipality: '香取市', siteCity: 'katori' },
  { prefecture: '千葉県', municipality: '佐倉市', siteCity: 'sakura-chiba' },
  { prefecture: '千葉県', municipality: '富津市', siteCity: 'futtsu' },
  { prefecture: '千葉県', municipality: '館山市', siteCity: 'tateyama-chiba' },
  { prefecture: '千葉県', municipality: '鴨川市', siteCity: 'kamogawa' },
  { prefecture: '埼玉県', municipality: '川越市', siteCity: 'kawagoe' },
  { prefecture: '埼玉県', municipality: 'さいたま市', siteCity: 'saitama' },
  { prefecture: '埼玉県', municipality: '秩父市', siteCity: 'chichibu' },
  { prefecture: '埼玉県', municipality: '長瀞町', siteCity: 'nagatoro' },
  { prefecture: '埼玉県', municipality: '飯能市', siteCity: 'hanno' },
  { prefecture: '福井県', municipality: '福井市', siteCity: 'fukui' },
  { prefecture: '福井県', municipality: '永平寺町', siteCity: 'eiheiji' },
  { prefecture: '福井県', municipality: '勝山市', siteCity: 'katsuyama' },
  { prefecture: '福井県', municipality: '大野市', siteCity: 'ono-fukui' },
  { prefecture: '福井県', municipality: '坂井市', siteCity: 'sakai-fukui' },
  { prefecture: '北海道', municipality: '羅臼町', siteCity: 'rausu' },
  { prefecture: '北海道', municipality: '利尻富士町', siteCity: 'rishirifuji' },
  { prefecture: '北海道', municipality: '礼文町', siteCity: 'rebun' },
  { prefecture: '山梨県', municipality: '富士吉田市', siteCity: 'fujiyoshida' },
  { prefecture: '山梨県', municipality: '富士河口湖町', siteCity: 'fujikawaguchiko' },
  { prefecture: '山梨県', municipality: '甲府市', siteCity: 'kofu' },
  { prefecture: '山梨県', municipality: '甲州市', siteCity: 'koshu' },
  { prefecture: '滋賀県', municipality: '彦根市', siteCity: 'hikone' },
  { prefecture: '滋賀県', municipality: '甲賀市', siteCity: 'koka' },
  { prefecture: '沖縄県', municipality: '那覇市', siteCity: 'naha' },
  { prefecture: '沖縄県', municipality: '糸満市', siteCity: 'itoman' },
  { prefecture: '沖縄県', municipality: '南城市', siteCity: 'nanjo' },
  { prefecture: '沖縄県', municipality: '北中城村', siteCity: 'kitanakagusuku' },
  { prefecture: '沖縄県', municipality: '本部町', siteCity: 'motobu' },
  { prefecture: '沖縄県', municipality: '今帰仁村', siteCity: 'nakijin' },
  { prefecture: '沖縄県', municipality: '国頭村', siteCity: 'kunigami' },
  { prefecture: '沖縄県', municipality: '恩納村', siteCity: 'onna' },
  { prefecture: '沖縄県', municipality: '読谷村', siteCity: 'yomitan' },
  { prefecture: '沖縄県', municipality: '豊見城市', siteCity: 'tomigusuku' },
  { prefecture: '沖縄県', municipality: '渡嘉敷村', siteCity: 'tokashiki' },
  { prefecture: '沖縄県', municipality: '座間味村', siteCity: 'zamami' },
  { prefecture: '沖縄県', municipality: '石垣市', siteCity: 'ishigaki' },
  { prefecture: '沖縄県', municipality: '竹富町', siteCity: 'taketomi' },
  { prefecture: '沖縄県', municipality: '与那国町', siteCity: 'yonaguni' },
  { prefecture: '群馬県', municipality: '草津町', siteCity: 'kusatsu' },
  { prefecture: '群馬県', municipality: 'みなかみ町', siteCity: 'minakami' },
  { prefecture: '群馬県', municipality: '渋川市', siteCity: 'shibukawa' },
  { prefecture: '群馬県', municipality: '高崎市', siteCity: 'takasaki' },
  { prefecture: '富山県', municipality: '富山市', siteCity: 'toyama' },
  ...
  { prefecture: '岩手県', municipality: '大船渡市', siteCity: 'ofunato' },
  { prefecture: '宮城県', municipality: '南三陸町', siteCity: 'minamisanriku' },
  { prefecture: '大分県', municipality: '杵築市', siteCity: 'kitsuki' },
  { prefecture: '和歌山県', municipality: '串本町', siteCity: 'kushimoto' },
  { prefecture: '和歌山県', municipality: '白浜町', siteCity: 'shirahama' },
  ...
  { prefecture: '北海道', municipality: '室蘭市', siteCity: 'muroran' },
  { prefecture: '北海道', municipality: '苫小牧市', siteCity: 'tomakomai' },
  { prefecture: '北海道', municipality: '壮瞥町', siteCity: 'sobetsu' },
  { prefecture: '北海道', municipality: '新ひだか町', siteCity: 'shinhidaka' },
