...
const transportOptions: readonly TransportCardProps[] = [
  ...
  },
  {
    ...
    description:
      "Подходит тем, кто любит максимально гибко и свободно строить свой день. Удобен для шоппинга, особенно уместен для пожилых и маломобильных гостей, и заодно даёт хороший шанс познакомиться с люксовым японским автопромом.",
    href: "/city-tour/private",
