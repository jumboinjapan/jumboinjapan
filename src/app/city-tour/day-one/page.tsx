...
const program = typoDeep({
  ...
  description:
    "Эта обзорная программа Токио подобрана мной специально для глубокого знакомства с городом. Маршрут проходит через районы Гинза, сад Хамарикю, рынок Цукидзи, святилище Мэйдзи, молодёжные кварталы Харадзюку и перекрёсток Сибуя, чтобы увидеть разные грани Токио — от старых традиций и японских садов до гастрономии и молодёжных субкультур в сердце современного мегаполиса. Такой маршрут особенно подходит тем, кто хочет увидеть главное, что есть в городе, в максимально эффективном темпе.",
  duration: "6–8 часов",
});
