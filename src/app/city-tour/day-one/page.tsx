...
const stops: Stop[] = [
  ...
  },
  {
    ...
    number: "05 · Вечер",
    title: "Харадзюку",
    text: "Харадзюку — это Токио, который постоянно примеряет на себя новые роли. Такэсита-дори, главная улица района, узкая, шумная и нарочито перегруженная деталями: здесь японская молодёжь собирает свою идентичность из моды, музыки, субкультур и уличной энергии. Даже если вы не планируете ничего покупать, пройти через Харадзюку стоит хотя бы ради ощущения этого живого городского эксперимента.\n\nОтсюда особенно хорошо видно, насколько разным может быть Токио на расстоянии нескольких кварталов. После лесной тишины Мэйдзи Дзингу этот район воспринимается как резкое возвращение к пульсу большого города.",
    duration: "~45 минут",
  ...
  },
  {
    ...
    number: "06 · Вечер",
    title: "Сибуя",
    text: "Сибуя — логичное завершение первого дня, потому что здесь городской ритм Токио собирается в максимально концентрированную форму. Тысячи людей одновременно переходят перекрёсток, потоки света отражаются в стекле, а с верхних этажей Scramble Square этот район выглядит как идеально настроенная система движения и шума.\n\nМы поднимаемся на смотровую площадку, смотрим на город сверху и спокойно проговариваем впечатления дня. Это удобная финальная точка, чтобы собрать воедино всё увиденное — от исторических садов и храмов до модных районов и повседневной городской энергии.",
    duration: "~45 минут",
