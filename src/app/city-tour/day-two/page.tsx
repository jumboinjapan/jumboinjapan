...
const logistics = {
  options: [
    ...
    },
    {
      ...
      text: "Транспорт по договорённости сопровождает весь день: встречает у отеля, ждёт у каждой точки, покупки и вещи остаются в машине. Силы уходят на впечатления, а темп дня — полностью ваш.",
    },
    {
