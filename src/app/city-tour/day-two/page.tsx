...
const logistics = {
  intro:
    "Программа по Токио в основном пешеходная, поэтому от формата передвижения зависит не столько скорость, сколько ритм дня.",
  options: [
    {
      title: "Общественный транспорт",
      text: "Переезды между районами короткие и почти не сказываются на ритме дня. По дороге видно обычный, будничный Токио — тот, в котором живут сами токийцы, и это часть впечатления от города.",
      href: "/city-tour/public",
      image: "/city-tour-transport-public-v2.jpg",
    },
    {
      title: "Частный транспорт",
      text: "За день можно охватить районы в разных концах города и места, куда пешком идти далеко. В Токио под такой формат собраны отдельные программы с более широкой географией и спокойным темпом.",
      href: "/city-tour/private",
      image: "/city-tour-transport-private-v4.jpg",
    },
    {
      title: "Заказной транспорт",
      text: "Просторный минивэн лимузин-сервиса на весь день. Подходит семье или компании: все едут вместе, вещи и покупки остаются в машине, а погода и время суток на план дня не влияют.",
