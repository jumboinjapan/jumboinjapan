  ...
  options: [
    {
      ...
      text: "Маршрут реален и на общественном транспорте, но за пределами Токио он забирает заметную часть сил и времени: расписания, стыковки и очереди становятся частью программы. Вариант для тех, кому бюджет важнее темпа.",
    },
    {
      title: "Частный транспорт",
      text: "Транспорт по договорённости — формат, в котором выездной день раскрывается полностью: выезд от отеля, остановки по настроению, замены по погоде. Дорога превращается из логистики в часть тура.",
    },
    {
