...
const logistics = {
  intro:
    "От формата передвижения в выездном дне зависит и охват маршрута, и то, насколько свободно его можно перестроить.",
  options: [
    {
      title: "Общественный транспорт",
      text: "За городом день выстраивают вокруг расписания, и программа держится в его рамках — и по времени, и по географии. Подходит тем, кто путешествует налегке и не планирует менять маршрут по ходу дня.",
      href: "/intercity/public",
      image: "/city-tour-transport-public-v2.jpg",
    },
    {
      title: "Частный транспорт",
      text: "Самый естественный формат выездного дня: путь двери в двери, остановки там, где захочется задержаться, и программа, которую можно перестроить по погоде. Дорога здесь — часть маршрута, а не время между остановками.",
      href: "/intercity/private",
      image: "/city-tour-transport-private-v4.jpg",
    },
    {
      title: "Заказной транспорт",
      text: "Просторный минивэн лимузин-сервиса на весь день, включая дорогу за город и обратно. Спокойный вариант для семьи или компании, когда всем важно ехать вместе и держаться своего темпа.",
