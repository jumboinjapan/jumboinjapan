  ...
  return (
    <ResourcesSectionShell
      ...
      guidanceItems={[
        {
          title: 'Сначала повод',
          description: 'Ужин ради впечатления, важная бронь заранее или просто хороший вечер рядом с маршрутом — это три разных задачи, и рестораны лучше смотреть именно так.',
        },
        {
          title: 'Затем район',
