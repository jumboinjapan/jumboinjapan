...
const transportFormats = [
  {
    ...
    description:
      'Между регионами почти все большие переезды идут по железной дороге — это сильная сторона Японии и заметная часть впечатления от поездки. Вещи при этом обычно отправляют между городами отдельной службой, здесь это привычная практика.',
  ...
  },
  {
    ...
    description:
      'Опора маршрута там, где заканчиваются крупные города: вещи едут с вами, а дорога между местами становится частью программы. План при этом остаётся гибким — менять его можно уже по ходу поездки.',
  ...
  },
  {
    ...
    description:
      'Формат для отдельных дней и переездов внутри большой поездки: просторный минивэн лимузин-сервиса, когда семье или компании важно ехать вместе. В остальные дни маршрут остаётся на железной дороге и частном транспорте.',
      ...
      <section className="border-t border-[var(--border)] bg-[var(--bg-warm)] px-4 py-20 md:px-6 md:py-32">
        <div className="mx-auto w-full max-w-6xl space-y-14 md:space-y-16">
          ...
          <section className="space-y-6">
            ...
            <p className="max-w-3xl text-[15px] font-light leading-[1.85] text-[var(--text-muted)]">В большой поездке форматы обычно сочетаются: длинные переезды между регионами — по железной дороге, дни на местах — на частном транспорте, отдельные дни — на заказном.</p>
