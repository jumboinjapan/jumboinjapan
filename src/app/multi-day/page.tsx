...
const transportFormats = [
  {
    ...
    text: 'ЖД — быстрые перегоны между регионами: удобно на больших расстояниях, но каждый переезд добавляет вокзалы, пересадки и хлопоты с багажом — и так все дни поездки.',
  },
  {
