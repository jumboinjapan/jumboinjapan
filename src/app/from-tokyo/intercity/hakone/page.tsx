      ...
      <div className="mx-auto w-full max-w-6xl space-y-12 md:space-y-14">
        ...
        <header className="space-y-4 md:space-y-5">
          ...
          <p className="max-w-[64ch] font-sans text-[15px] font-light leading-[1.82] text-[var(--text-muted)]">
            Хаконэ — это горный район на старой дороге между Токио и Киото, куда едут не за одной
            точкой, а за сменой ритма. Здесь сходятся сразу несколько причин выбраться из города:
            вулканический ландшафт, озеро, онсэны, музеи и шанс увидеть Фудзи в живом масштабе, а не
            из окна синкансэна. Поэтому Хаконэ хорошо работает и как насыщенный день из Токио, и как
            остановка с ночёвкой по пути к Фудзи или дальше в Киото.
          </p>
        </header>
