        ...
        <section className="space-y-6">
          ...
          <div className="space-y-8 font-sans text-[15px] font-light leading-[1.8] text-[var(--text-muted)]">
            ...
            <div>
              ...
              <p>Основано в 757 году на вершине горы Комагатакэ — к берегу озера Асиноко перенесено в 1667 году. Посвящено покровителю путешественников, которых здесь всегда было много. Красные тории уходят основанием прямо в озеро: в ясную погоду отражаются в воде, в туман — исчезают полностью. Главное божество здесь — девятиглавый дракон, некогда наводивший ужас на округу, пока его не усмирил буддийский монах; с тех пор дракон считается защитником этих мест, а не их угрозой. Кедры, которые помнят оба эти периода, стоят так плотно, что утренний свет проходит сквозь них как сквозь фильтр — и в этой дозированной темноте начинаешь говорить тише.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p>Здесь к скульптуре относятся так, как Япония относится ко всему, что считает достойным внимания: серьёзно и без иронии. Роден стоит рядом с Миро, отдельный павильон отдан Пикассо — его керамика и гравюры, отдельная глава в биографии художника, которому тесно было в одном жанре. Всё это расставлено по склону холма так, что каждый следующий поворот тропы открывает что-то новое — и ты идёшь между работами, а не вдоль них. Среди скульптур встроены горячие ванночки для ног: выглядит как шутка ровно до того момента, как сидишь в одной и смотришь на горный склон.</p>
            </div>
          </div>
        </section>
