...
const transportOptions = [
  ...
  },
  {
    ...
    description: "Для групп, которым важен максимальный комфорт, можно заказать индивидуальный транспорт с водителем на целый день. Комфортабельный минивэн заберёт вас в условленных точках маршрута и при необходимости поможет доставить покупки в отель.",
