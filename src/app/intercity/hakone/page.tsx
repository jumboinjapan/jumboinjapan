  ...
  const timelineStops = routeStops.map((stop) => {
    ...
    if (stop.title === 'Хаконэ Дзиндзя') {
      return {
        ...
        sellingHighlights: [
          { title: 'Тории в воде', body: 'Ворота цвета киноварь у спуска к озеру.' },
          { title: 'Анзан-но-ки', body: 'Древнее дерево, у которого просят лёгких родов.' },
          { title: 'Пруд Бэндзайтэн (弁財天)', body: 'Небольшой пруд возле парковки.' },
        ],
      }
    }
