...
const whoItSuits =
  'Подходит тем, кто уже провёл день-другой в Токио и хочет выехать за город, но не просто ради видов, а ради цельного маршрута с другой географией и другим ощущением Японии. День здесь не спортивный: много панорам, немного ходьбы, один подъём на канатной дороге и естественные паузы, которые задают озеро и горный рельеф. Хорошо воспринимается парой, семьёй с детьми от восьми лет и небольшой группой. Гид на русском ведёт день целиком, снимает с вас местную логистику и помогает увидеть в Хаконэ не набор точек, а связный маршрут.'
      ...
      <div className="mx-auto w-full max-w-6xl space-y-12 md:space-y-14">
        ...
        <header className="space-y-4 md:space-y-5">
          ...
          <p className="max-w-3xl font-sans text-[15px] font-light leading-[1.82] text-[var(--text-muted)]">
            {isVariantB
              ...
              : 'Хаконэ стоит на старом тракте Токайдо, который веками связывал Эдо и Киото. Горы здесь живые — из земли идёт серный пар, вулканическая кальдера открывается с канатной дороги, а в ясный день над озером Аси стоит Фудзи. Маршрут охватывает пять точек: заставу эпохи сёгуната, синтоистское святилище у воды, подъём к кратеру, круиз по озеру и скульптурный парк под открытым небом. Удобно как отдельный день из Токио, так и как остановка по дороге в Киото — с ночёвкой маршрут раскрывается ещё полнее.'}
          </p>
        ...
        <section className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="max-w-3xl font-sans text-[15px] font-light leading-[1.8] text-[var(--text-muted)]">
              Из Токио в Хаконэ можно добраться поездом или на машине — выбор влияет на гибкость маршрута и то, сколько успеете увидеть. Ниже — короткая ориентация по форматам; под конкретный состав группы и темп подберём логистику при бронировании.
            </p>
          </div>
        ...
        <section className="rounded-sm border border-[var(--border)] bg-[var(--surface)] px-6 py-8 space-y-4">
          ...
          <p className="max-w-2xl font-sans text-[15px] font-light leading-[1.8] text-[var(--text-muted)]">
            Напишите — обсудим программу, стоимость и удобные даты. Маршрут можно подстроить под ваш ритм: выехать пораньше, добавить ночёвку с онсэном или скомбинировать с дорогой в Киото.
          </p>
