    ...
    if (stop.title === 'Хаконэ Дзиндзя') {
      return {
        ...
        sellingHighlights: [
          ...
          { title: 'Анзан-но-ки (安産の木)', body: 'Древнее дерево лёгких родов — одно из самых почитаемых мест святилища.' },
          { title: 'Пруд Бэндзайтэн (弁財天)', body: 'Небольшой пруд в глубине леса с древней корягой — место силы, о котором знают не все посетители.' },
        ],
      }
    }
  ...
  return (
    <>
      ...
      <PageHero
        ...
        subtitle="Хаконэ — день, когда Токио постепенно остаётся позади, а маршрут раскрывается через озеро Аси, кедровые аллеи, вулканическую долину Овакудани и спокойный ритм горного курорта. Программу можно гибко перестроить по погоде: даже в дождь здесь остаются удобные и интересные варианты — музеи, онсэны, видовые точки и закрытые пространства."
        ...
        <div className="mx-auto w-full max-w-6xl space-y-10 md:space-y-14">
          ...
          <section className="space-y-4 md:space-y-6">
            ...
            <p className="max-w-3xl font-sans text-[15px] font-light leading-[1.85] text-[var(--text)] md:text-[16px]">
              Хаконэ кажется простым на карте, но в реальности день зависит от погоды, расписания местного транспорта, очередей, пересадок и того, видна ли гора Фудзи. Задача гида — не просто рассказать историю, а сохранить цельность дня: вовремя поменять маршрут, убрать лишнее и предложить альтернативы.
            </p>
