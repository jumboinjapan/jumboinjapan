      ...
      <section className="border-t border-[var(--border)] bg-[var(--bg-warm)] px-4 py-12 md:px-6 md:py-16">
        <div className="mx-auto w-full max-w-6xl space-y-10 md:space-y-14">
          ...
          <section className="space-y-4 md:space-y-6">
            ...
            />
            <p className="max-w-3xl font-sans text-[15px] font-light leading-[1.85] text-[var(--text)] md:text-[16px]">
              День в Хаконе зависит от погоды, видимости на гору Фудзи и загруженности мест маршрута. Задача гида — не просто рассказать историю, а сохранить цельность маршрута, предлагая альтернативы и дополнения по ситуации.
            </p>
            <div className="grid gap-6 md:grid-cols-3">
              <div className="rounded-lg border border-[var(--border)] bg-[var(--bg-warm)] p-6">
                <p className="font-sans text-[15px] font-light leading-[1.85] text-[var(--text-muted)]">Частный транспорт — свободный ритм дня</p>
              </div>
              <div className="rounded-lg border border-[var(--border)] bg-[var(--bg-warm)] p-6">
          ...
          <section className="space-y-6 md:space-y-8">
            ...
            <p className="text-[13px] text-[var(--text-muted)]">Хаконе — маршрут с широкой географией и переменчивой погодой, поэтому здесь особенно заметна разница между форматами.</p>
