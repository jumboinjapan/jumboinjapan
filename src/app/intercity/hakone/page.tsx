        ...
        <header className="space-y-4 md:space-y-5">
          ...
          <p className="max-w-3xl font-sans text-[15px] font-light leading-[1.82] text-[var(--text-muted)]">
            {isVariantB
              ...
              : 'Хаконэ лежит на старом тракте Токайдо, который веками связывал Эдо и Киото. Здесь особенно ясно чувствуется, как в одном месте сходятся разные слои Японии: дорога эпохи сёгуната, озеро Аси, святилище у воды, вулканический рельеф и музей под открытым небом. В ясную погоду отсюда видно Фудзи. За один день Хаконэ даёт очень цельное впечатление, а если остаться на ночь и добавить онсэн, место воспринимается уже совсем иначе.'}
          </p>
