  ...
  return (
    <>
      ...
      <PageHero
        ...
        title="День в Хаконэ"
        subtitle="Хаконэ — это день, когда мегаполис остаётся за спиной: озеро Аси, кедровые аллеи, вулканическая долина Овакудани и маршрут, который можно адаптировать даже под дождливую погоду."
