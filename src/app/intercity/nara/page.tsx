...
const whoItSuitsCards = [
  {
    ...
    description:
      'Олени и Тодайдзи — маршрут понятен детям: пространство, животные и большая статуя.',
  },
  {
    title: 'Первое знакомство с Кансаем',
    description:
      'Нара — хорошее начало или дополнение к программе Киото и Осаки: история и природа без городской плотности.',
  },
  {
    title: 'Пары и неторопливые туры',
    description:
      'Парк, исторические кварталы и тишина Касуги — день с характером без суеты.',
  },
] as const
...
export default async function NaraPage() {
  ...
  const transportOptions = [
    {
      ...
      summary: 'За городом день выстраивают вокруг расписания, и программа держится в его рамках — и по времени, и по географии. Подходит тем, кто путешествует налегке и не планирует менять маршрут по ходу дня.',
      href: '/intercity/public',
      image: '/city-tour-transport-public-v2.jpg',
    },
    {
      title: 'Частный транспорт',
      summary: 'Самый естественный формат выездного дня: путь двери в двери, остановки там, где захочется задержаться, и программа, которую можно перестроить по погоде. Дорога здесь — часть маршрута, а не время между остановками.',
      href: '/intercity/private',
      image: '/city-tour-transport-private-v4.jpg',
    },
    {
      title: 'Заказной транспорт',
      summary: 'Просторный минивэн лимузин-сервиса на весь день, включая дорогу за город и обратно. Спокойный вариант для семьи или компании, когда всем важно ехать вместе и держаться своего темпа.',
  ...
  return (
      ...
      <section className="border-t border-[var(--border)] bg-[var(--bg-warm)] px-4 py-12 md:px-6 md:py-16">
        <div className="mx-auto w-full max-w-6xl space-y-10 md:space-y-14">
          ...
          <section className="space-y-4 md:space-y-6">
            <SectionHeading eyebrow="Специфика тура" title="Комфортный день у истоков японской истории." />
            <p className="max-w-3xl font-sans text-[15px] font-light leading-[1.85] text-[var(--text)] md:text-[16px]">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <div className="rounded-lg border border-[var(--border)] bg-[var(--bg-warm)] p-6">
                <p className="font-sans text-[15px] font-light leading-[1.85] text-[var(--text-muted)]">Большой Будда в Тодайдзи</p>
              </div>
              <div className="rounded-lg border border-[var(--border)] bg-[var(--bg-warm)] p-6">
                <p className="font-sans text-[15px] font-light leading-[1.85] text-[var(--text-muted)]">Священные олени</p>
              </div>
              <div className="rounded-lg border border-[var(--border)] bg-[var(--bg-warm)] p-6">
                <p className="font-sans text-[15px] font-light leading-[1.85] text-[var(--text-muted)]">Касуга Тайся — тысячи фонарей</p>
              </div>
            </div>
          </section>

          <section className="space-y-6 md:space-y-8">
            <SectionHeading eyebrow="Маршрут" title="Нара: первая столица и парк с оленями" />
          ...
          <p className="font-sans text-[14px] font-light leading-[1.8] text-[var(--text-muted)]">
            Хотите добавить Осаку или Удзи?{' '}
          ...
          {curatedHelperPois.length > 0 && (
            <section className="space-y-6 md:space-y-8">
              <SectionHeading
                ...
                description="Нара небольшая. При желании добавить глубины — ниже варианты в регионе."
              />
          ...
          <section className="space-y-6 md:space-y-8">
            ...
            <p className="text-[13px] text-[var(--text-muted)]">В Нару обычно едут из Киото или Осаки отдельным днём — по железной дороге это самый простой вариант.</p>
          ...
          <section id="cta" className="scroll-mt-24 grid gap-6 rounded-lg border border-[var(--border)] bg-[var(--surface)] px-6 py-7 md:grid-cols-[minmax(0,1fr)_auto] md:items-end md:px-8 md:py-8">
            <div className="space-y-3">
              ...
              <p className="max-w-2xl font-sans text-[15px] font-light leading-[1.85] text-[var(--text-muted)]">
                Нара удобна и как полдня, и как цельный день — легко встраивается в ваш маршрут по Кансаю.
              </p>
            </div>
              ...
              <div className="grid gap-3 md:grid-cols-3">
                ...
                >
                  <div className="space-y-3">
                    ...
                    <p className="font-sans text-[14px] font-light leading-[1.75] text-[var(--text-muted)]">Классическое первое знакомство со старой столицей.</p>
                  </div>
                ...
                >
                  <div className="space-y-3">
                    ...
                    <p className="font-sans text-[14px] font-light leading-[1.75] text-[var(--text-muted)]">Другой темперамент — замок, Дотонбори и живая городская среда.</p>
                  </div>
                  <span className="mt-5 inline-flex items-center gap-2 text-[13px] font-medium text-[var(--text-muted)] transition-colors group-hover:text-[var(--accent)]">
                    Посмотреть маршрут
                    <ArrowRight className="h-3.5 w-3.5" aria-hidden="true" />
                ...
                >
                  <div className="space-y-3">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <p className="text-[13px] font-medium text-[var(--accent)]">чайная культура</p>
                    </div>
                    <p className="font-sans text-[14px] font-light leading-[1.75] text-[var(--text-muted)]">Камерный маршрут с Бёдо-ин и чайной историей.</p>
                  </div>
                  <span className="mt-5 inline-flex items-center gap-2 text-[13px] font-medium text-[var(--text-muted)] transition-colors group-hover:text-[var(--accent)]">
                    Посмотреть маршрут
                    <ArrowRight className="h-3.5 w-3.5" aria-hidden="true" />
    ...
    <RouteFaq slug="intercity/nara" />
    <JournalMentions
      routeSlug="intercity/nara"
      poiIds={timelineStops.map((s) => s.poiId).filter((id): id is string => Boolean(id))}
      locationNames={[...timelineStops.map((s) => s.title), 'Нара']}
