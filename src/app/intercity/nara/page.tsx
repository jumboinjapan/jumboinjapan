...
const whoItSuitsCards = [
  {
    ...
    description:
      'Олени и Тодайдзи — маршрут легко читается детьми: пространство, животные и большая статуя.',
  },
  {
    title: 'Первое знакомство с Кансаем',
    description:
      'Нара — хорошее начало или дополнение к Киото и Осаке: история и природа без городской плотности.',
  },
  {
