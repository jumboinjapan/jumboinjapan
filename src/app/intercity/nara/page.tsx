      ...
      <section className="border-t border-[var(--border)] bg-[var(--bg-warm)] px-4 py-12 md:px-6 md:py-16">
        <div className="mx-auto w-full max-w-6xl space-y-10 md:space-y-14">
          ...
          <section className="space-y-6 md:space-y-8">
            ...
            <p className="text-[13px] text-[var(--text-muted)]">Киото → Нара: ~45 мин на поезде. Осака → Нара: ~40 мин. Оптимально как дополнение к базированию в регионе.</p>
              ...
              <div className="grid gap-3 md:grid-cols-3">
                ...
                >
                  <div className="space-y-3">
                    ...
                    <div className="space-y-1.5">
                      <h3 className="text-[20px] font-medium text-[var(--text)] transition-colors group-hover:text-[var(--accent)]">Тур в Осаку</h3>
