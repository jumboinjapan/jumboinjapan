...
export async function generateMetadata(): Promise<Metadata> {
  ...
  openGraph: {
    ...
    images: [{ url: PAGE_IMAGE, width: 1200, height: 800, alt: 'Осенний Киото — храмовая пагода среди багряных клёнов, вид на город' }],
  },
}
}
...
export default async function Kyoto2Page() {
  ...
  return (
      ...
      <section className="border-t border-[var(--border)] bg-[var(--bg-warm)] px-4 py-12 md:px-6 md:py-16">
        <div className="mx-auto w-full max-w-6xl space-y-10 md:space-y-14">
          ...
          <section className="space-y-6 md:space-y-8">
            ...
            <p className="text-[13px] text-[var(--text-muted)]">Второй день в Киото рассчитан на тех, кто уже живёт в городе: программа в основном пешеходная, с короткими переездами.</p>
    ...
    <RouteFaq slug="intercity/kyoto-2" />
    <JournalMentions
      routeSlug="intercity/kyoto-2"
