...
const whoItSuitsCards = [
  {
    title: 'Те, кому мало Киото',
    description:
      'Канадзава даёт то же ощущение исторической Японии, но без толп и с другим характером.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Сад, кварталы и рынок хорошо читаются в спокойном темпе — особенно с ночёвкой.',
  },
] as const
      ...
      <section className="border-t border-[var(--border)] bg-[var(--bg-warm)] px-4 py-12 md:px-6 md:py-16">
        <div className="mx-auto w-full max-w-6xl space-y-10 md:space-y-14">
          <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-sm text-[var(--text-muted)]">
            ...
            <span aria-hidden="true" className="text-[var(--border)]">/</span>
            <span aria-current="page" className="font-medium text-[var(--text)]">Канадзава</span>
          </nav>
          {seo?.routeIntro ? (
          ...
          <IntercitySummaryStrip items={getIntercitySummary('kanazawa')} />

          <section className="space-y-4 md:space-y-6">
            <SectionHeading eyebrow="Специфика тура" title="Маленький Киото с собственным характером." />
            <p className="max-w-3xl font-sans text-[15px] font-light leading-[1.85] text-[var(--text)] md:text-[16px]">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <div className="rounded-lg border border-[var(--border)] bg-[var(--bg-warm)] p-6">
                <p className="font-sans text-[15px] font-light leading-[1.85] text-[var(--text-muted)]">Кэнрокуэн — сад национального сокровища</p>
              </div>
              <div className="rounded-lg border border-[var(--border)] bg-[var(--bg-warm)] p-6">
                <p className="font-sans text-[15px] font-light leading-[1.85] text-[var(--text-muted)]">Квартал гейш Хигаси Тяя</p>
              </div>
              <div className="rounded-lg border border-[var(--border)] bg-[var(--bg-warm)] p-6">
                <p className="font-sans text-[15px] font-light leading-[1.85] text-[var(--text-muted)]">Музей современного искусства</p>
              </div>
            </div>
          </section>

          <section className="space-y-6 md:space-y-8">
            <SectionHeading eyebrow="Маршрут" title="Канадзава: сад, замок и чайный квартал" />
          ...
          <p className="font-sans text-[14px] font-light leading-[1.8] text-[var(--text-muted)]">
            Хотите остаться на ночь или добавить рынок?{' '}
          ...
          <section className="space-y-6 md:space-y-8">
            ...
            <p className="text-[13px] text-[var(--text-muted)]">До Канадзавы едут по железной дороге, и это заметная часть впечатления; с ночёвкой город раскрывается значительно шире.</p>
              ...
              <div className="grid gap-3 md:grid-cols-3">
                ...
                >
                  <div className="space-y-3">
                    ...
                    <p className="font-sans text-[14px] font-light leading-[1.75] text-[var(--text-muted)]">Больше туристов, но больше символов — другой формат исторического города.</p>
                  </div>
                ...
                >
                  <div className="space-y-3">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <p className="text-[13px] font-medium text-[var(--accent)]">горы и онсэн</p>
                    </div>
                    <p className="font-sans text-[14px] font-light leading-[1.75] text-[var(--text-muted)]">Совсем другое — природа, вулкан и онсэн вместо города.</p>
                  </div>
                  <span className="mt-5 inline-flex items-center gap-2 text-[13px] font-medium text-[var(--text-muted)] transition-colors group-hover:text-[var(--accent)]">
                    Посмотреть маршрут
                    <ArrowRight className="h-3.5 w-3.5" aria-hidden="true" />
                ...
                >
                  <div className="space-y-3">
                    ...
                    <p className="font-sans text-[14px] font-light leading-[1.75] text-[var(--text-muted)]">Контраст к Канадзаве — живая и громкая Осака.</p>
                  </div>
                  <span className="mt-5 inline-flex items-center gap-2 text-[13px] font-medium text-[var(--text-muted)] transition-colors group-hover:text-[var(--accent)]">
                    Посмотреть маршрут
                    <ArrowRight className="h-3.5 w-3.5" aria-hidden="true" />
