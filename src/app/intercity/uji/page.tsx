...
const whoItSuitsCards = [
  {
    ...
    description:
      'Удзи идеален как второй день или дополнение к программе Киото — час пути, другой масштаб и темп.',
  },
  {
    title: 'Любители японского чая',
    description:
      'Удзи производит лучший маття в Японии: дегустации, магазины и традиция прямо на месте.',
  },
  {
    title: 'Пары и медленные маршруты',
    description:
      ...
      <section className="border-t border-[var(--border)] bg-[var(--bg-warm)] px-4 py-12 md:px-6 md:py-16">
        <div className="mx-auto w-full max-w-6xl space-y-10 md:space-y-14">
          ...
          <section className="space-y-4 md:space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <div className="rounded-lg border border-[var(--border)] bg-[var(--bg-warm)] p-6">
                <p className="font-sans text-[15px] font-light leading-[1.85] text-[var(--text-muted)]">Бёдо-ин — монета в 10 иен</p>
              </div>
              <div className="rounded-lg border border-[var(--border)] bg-[var(--bg-warm)] p-6">
                <p className="font-sans text-[15px] font-light leading-[1.85] text-[var(--text-muted)]">Удзигами — старейший синтоистский храм</p>
              </div>
              <div className="rounded-lg border border-[var(--border)] bg-[var(--bg-warm)] p-6">
                <p className="font-sans text-[15px] font-light leading-[1.85] text-[var(--text-muted)]">Чай маття на месте</p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-6 md:space-y-8">
            ...
            <p className="text-[13px] text-[var(--text-muted)]">Удзи — короткая поездка из Киото, которая хорошо встаёт отдельным полуднем внутри маршрута по региону.</p>
              ...
              <div className="grid gap-3 md:grid-cols-3">
                ...
                >
                  <div className="space-y-3">
                    ...
                    <p className="font-sans text-[14px] font-light leading-[1.75] text-[var(--text-muted)]">Час от Удзи — первая столица Японии с парком оленей.</p>
                  </div>
                ...
                >
                  <div className="space-y-3">
                    ...
                    <p className="font-sans text-[14px] font-light leading-[1.75] text-[var(--text-muted)]">Основная программа рядом — удобно делать вместе.</p>
                  </div>
                  <span className="mt-5 inline-flex items-center gap-2 text-[13px] font-medium text-[var(--text-muted)] transition-colors group-hover:text-[var(--accent)]">
                    Посмотреть маршрут
                    <ArrowRight className="h-3.5 w-3.5" aria-hidden="true" />
                ...
                >
                  <div className="space-y-3">
                    ...
                    <p className="font-sans text-[14px] font-light leading-[1.75] text-[var(--text-muted)]">Другой ритм — живая Осака с замком и Дотонбори.</p>
                  </div>
                  <span className="mt-5 inline-flex items-center gap-2 text-[13px] font-medium text-[var(--text-muted)] transition-colors group-hover:text-[var(--accent)]">
                    Посмотреть маршрут
                    <ArrowRight className="h-3.5 w-3.5" aria-hidden="true" />
