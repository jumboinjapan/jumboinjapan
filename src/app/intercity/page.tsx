...
const transportOptions = [
  ...
  },
  {
    ...
    description:
      "Транспорт по договорённости — формат, в котором выездной день раскрывается полностью: выезд от отеля, остановки по настроению, замены по погоде. Дорога превращается из логистики в часть тура.",
