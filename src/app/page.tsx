...
const approach = typoDeep({
  ...
  columnOne:
    "Япония часто остаётся понятой лишь наполовину: насыщенное путешествие превращается в набор красивых кадров, если в нём не хватает контекста, ритма и правильной драматургии. Человек приезжает к нам со своими ожиданиями и искажёнными представлениями о том, какой он хочет увидеть Японию.",
  columnTwo:
      ...
      <section className="relative isolate overflow-hidden border-b border-[var(--border)] bg-[var(--text)] text-[var(--surface)]">
        <div className="absolute inset-0">
          <Image
            ...
            sizes="100vw"
          />
          <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(20,12,7,0.74)_0%,rgba(20,12,7,0.66)_34%,rgba(20,12,7,0.46)_62%,rgba(20,12,7,0.21)_100%)]" />
          <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(20,12,7,0.16)_0%,rgba(20,12,7,0.05)_24%,rgba(20,12,7,0.59)_100%)]" />
        </div>
