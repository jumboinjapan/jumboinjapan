      ...
      <section className="border-b border-[var(--border)] bg-[var(--surface)] px-4 py-14 md:px-6 md:py-20">
        <div className="mx-auto grid w-full max-w-6xl gap-10 lg:grid-cols-[minmax(0,1.15fr)_minmax(280px,0.85fr)] lg:gap-16">
          ...
          <div className="space-y-5 text-[15px] font-light leading-[1.85] text-[var(--text-muted)] md:text-base">
            <p>
              Путешествие во многом похоже на спектакль. Один и тот же сюжет можно прожить по-разному: кому-то ближе
              ясная классика и главные сцены, кому-то важнее паузы, детали, внутренний ритм и менее очевидные ходы.
            </p>
            <p>
              Поэтому хороший маршрут начинается не со списка мест, а с понимания того, какой жанр поездки ближе именно
              вам. Работа гида в том, чтобы почувствовать эту драматургию и собрать Японию так, чтобы страна раскрывалась
              в правильной последовательности и с нужной глубиной.
            </p>
          </div>
        </div>
      </section>
