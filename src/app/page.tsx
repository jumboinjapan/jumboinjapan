...
const aboutCards = [
  ...
  },
  {
    ...
    text: "Возможно, вы хотели бы организовать поездку под ключ, выполненную с учетом всех ваших пожеланий: подбор отелей, ресторанов и заказ частного транспорта. Вертолётные прогулки, мастер-классы и закрытые сады. Возможно, это ваша категория.",
  },
  {
    title: "Фокус маршрутов",
    text: "Подумайте о том, что в поездках вам доставляет радость и удовольствие: прогулки на природе, любование арт-объектами, необычный шоппинг, гостиничный отдых и спа. Вокруг этих предпочтений можно сложить ритм поездки по стране.",
  },
] as const;
      ...
      <section className="border-b border-[var(--border)] bg-[var(--surface)] px-4 py-16 md:px-6 md:py-24">
        <div className="mx-auto grid w-full max-w-6xl gap-12 lg:grid-cols-[minmax(0,1.02fr)_minmax(320px,0.98fr)] lg:gap-20">
          ...
          <div className="max-w-[38rem] space-y-6 text-[16px] font-light leading-[1.92] text-[var(--text-muted)] lg:pt-1">
            ...
            <p>
              Моя задача — сделать так, чтобы маршрут имел форму и был чуть больше, чем просто списком мест для
              посещения.
            </p>
          </div>
        </div>
