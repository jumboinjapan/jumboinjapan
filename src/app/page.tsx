...
const journeyFormats = [
  {
    ...
    highlights: [
      "Токио по районам — Асакуса, Янака, Симокитадзава, Курамаэ: куда идти и почему именно туда",
      "Скажите, что вам интересно — и получите маршрут под себя, а не под среднего туриста",
      "Пешком, без петель и случайных остановок — только то, что стоит вашего времени",
    ],
  },
  {
