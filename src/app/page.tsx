...
const aboutCards = [
  ...
  },
  {
    ...
    text: "Возможно вы хотели бы организовать поездку под ключ выполненную с учетом всех ваших пожеланий, подбор отелей, ресторанов и заказ частного транспорта. Вертолётные прогуки, мастерклаccы и закрытые сады.",
  },
  {
