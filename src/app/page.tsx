...
const journeyFormats = [
  {
    ...
    highlights: [
      ...
      "Найдите «свои» районы Токио",
      "Постройте маршрут под собственный ритм",
    ],
  },
  {
    ...
    summary:
      "Нельзя почувствовать страну, оставаясь только в одном городе. Никко, Хаконэ, Фудзи — однодневные поездки из Токио. У каждого направления своя душа: природа, история, традиции, праздники и развлечения.",
        ...
        <div className="mx-auto grid w-full max-w-6xl gap-12 lg:grid-cols-[minmax(0,1.02fr)_minmax(320px,0.98fr)] lg:gap-20">
          ...
          <div className="max-w-[38rem] space-y-6 text-[16px] font-light leading-[1.92] text-[var(--text-muted)] lg:pt-1">
            <p>
              ...
              красивых кадров, если в нём не хватает контекста, ритма и той оптики, которая помогает понять, что именно с
              тобой происходит. Я думаю об этом с самого начала, ещё когда мы только разговариваем о поездке: что человек
              хочет получить, что ему важно увезти с собой. От этого зависит, с чего начать, где дать паузу, а где дать
              кульминацию. Одному нужна точка входа через тихий храмовый район, другому сразу в гущу токийского ритма.
            ...
            <p>
              ...
              характер районов, региональные различия, культурные коды и их истоки, ту повседневность, из которой и
              складывается настоящее впечатление о стране. И сделать так, чтобы маршрут имел форму: не просто список
              достопримечательностей, а что-то с началом, серединой и моментом, который потом долго помнишь.
            </p>
          </div>
        </div>
      </section>
