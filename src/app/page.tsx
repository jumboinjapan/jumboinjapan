...
const journeyFormats = [
  {
    ...
    highlights: [
      "Асакуса, Сибуя, Синдзюку, Янака — ключевые районы в одном маршруте",
      "Храмы, сады и архитектура без лишних слов — просто лучшее из Токио",
      "Размеренный темп: без марафонов по метро и галочек в списке",
    ],
  },
  {
