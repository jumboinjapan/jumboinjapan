...
const approach = typoDeep({
  ...
  columnTwo:
    "Я как драматург решаю, с чего начать, где сделать паузу, а где устроить кульминацию. Кому-то нужна точка входа через тихий храмовый район, другому через арт-пространство, а третьему — сразу гуща молодёжного района. Нюансы планирования, которые невозможны без личного контакта со зрителем.",
  conclusion:
