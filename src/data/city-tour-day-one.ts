...
// Shared complete program for the public route and its editorial preview.
...
export const stops: CityTourStop[] = typoDeep([
  {
    id: "ginza",
    number: "01 · Утро",
    title: "Гинза",
...
export const logistics = typoDeep({
  intro:
