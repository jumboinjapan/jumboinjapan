...
export const hakoneOnsen: TourAddition = {
  ...
  displayTitle: 'Tenseien',
  caption: 'Термальные источники',
...
export const hakoneLunch: TourAddition[] = [
  {
    ...
    displayTitle: 'Kihinkan',
    caption: 'Соба в исторической вилле',
  ...
  },
  {
    ...
    displayTitle: 'Kaikatei',
    caption: 'Обед у сада музея Окада',
