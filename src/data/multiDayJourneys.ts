...
export const multiDayJourneys: MultiDayJourney[] = [
  {
    ...
    days: [
      ...
      },
      {
        ...
        transfers: [
          { from: 'Токио', to: 'Хаконе', mode: 'ЖД или автомобиль', note: 'Утренний переезд с багажом' },
        ],
        regions: [
          {
            name: 'Канто',
  ...
  },
  {
    ...
    days: [
      ...
      },
      {
        ...
        transfers: [
          { from: 'Такаяма', to: 'Сиракава-го', mode: 'автомобиль или автобус', note: 'Переезд по долине' },
          { from: 'Сиракава-го', to: 'Такаяма', mode: 'автомобиль или автобус', note: 'Возвращение вечером' },
        ],
        regions: [
          {
            name: 'Тюбу',
      ...
      },
      {
        ...
        transfers: [
          { from: 'Такаяма', to: 'Канадзава', mode: 'автомобиль', note: 'Через Сиракава-го или долину' },
        ],
        regions: [
          {
            name: 'Хокурику',
