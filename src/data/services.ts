...
export const experienceServices: ExperienceService[] = [
  ...
  },
  {
    ...
    duration_min: 150,
    description:
      "Рамэн и суши в одном занятии — единственное такое сочетание в Японии. Безлимитное премиальное сакэ трёх сортов и японское пиво. Малая группа до 8 человек, профессиональные фото включены. Расположен в Цукисима — 10 минут от Гинзы, рядом с Цукидзи и teamLab Planets.",
    agent_notes:
  ...
  },
  {
    ...
    duration_min: 240,
    description:
      "Профессиональная кухня ресторана в Мегуро. Четыре часа интенсивной готовки: два вида бульона с нуля, гёдза от начала до конца. Рецептурный буклет на 52 страницы и персональная фотография в подарок. Преподают профессиональные рамэн-шефы. Рядом с набережной реки Мегуро с сакурой.",
    agent_notes:
