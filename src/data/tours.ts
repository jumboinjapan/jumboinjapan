...
export const tours: Tour[] = [
  ...
  },
  {
    ...
    title: "Тур в Хаконе из Токио с гидом на русском",
    shortTitle: "Хаконе",
    titleEn: "Hakone",
    description: "Тур в Хаконе из Токио с русскоязычным гидом: онсэн, кратер Овакудани, озеро Аси, круиз с видом на Фудзи и музей под открытым небом за один день или уикенд.",
  ...
  },
  {
    ...
    shortTitle: "Камакура",
    titleEn: "Kamakura",
    description: "Великий Будда в Котоку-ин, бамбуковая роща Хококудзи, пляж Юйгахама и Иокогама — древняя столица Японии в одном дне, всего в часе от Токио на прямом поезде.",
    duration: "День",
    region: "Канто",
    category: "intercity",
    priority: 0.8,
